...
public class ViewContactFieldCreator extends FieldCreator {

    public ViewContactFieldCreator(ViewDataActivity activity, ViewData data) {
        super(activity, data);
    }
    ...
    public View createView() {
        ...
        if (data.getDataValue("photo") != null) {
        ...
        textName.setText( data.getDataValue("fullname").getValue().toString());
