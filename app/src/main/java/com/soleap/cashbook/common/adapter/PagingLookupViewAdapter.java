...
public class PagingLookupViewAdapter extends RecyclerViewAdapter {
    ...
    public PagingLookupViewAdapter(Context context, String documentName, int viewResource) {
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        final Document document = (Document) dataSet.get(position);
        if (document != null) {
            DocListItemViewHolder viewHolder = (DocListItemViewHolder) holder;
            viewHolder.bind(position, document);
        }
    }
